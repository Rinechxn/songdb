...
const CardFile: React.FC<CardFileProps> = ({ data }) => {
    ...
    return (
        <>
            ...
            <section className=" bg-[#202020] hover:bg-[#646464] duration-150 border rounded-lg border-[#3a3a3a] flex flex-col md:flex-row items-center md:justify-between md:space-x-3 w-full">
                <button onClick={handlePlay} className='py-2 px-2'>
                    <div className="flex items-center space-x-2 w-full">
                        <div className=''>
                            {fileDetails.fileName == data.file_name ? <WaveFormIcon /> : <PlaySolidIcon />}
                        </div>
                        <div className="flex flex-col justify-start min-w-0 max-w-[18rem] md:max-w-[29rem] lg:max-w-[32rem] xl:max-w-full">
                ...
                <div className='flex md:hidden py-1 border border-t border-x-0 border-b-0 border-white/20 md:border-0 w-full items-center justify-center'>
                    <div className="px-2 md:px-0 md:hidden flex space-x-2 text-sm items-center justify-between w-full px-">
                        ...
                        <div>
                            <button onClick={() => data && updateFav(data)} className=" text-[12px] flex space-x-1 items-center"> {/* Use onClick with custom handler */}
                                <div className="hover:opacity-40 duration-150">
                                    {!updatedFav ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" className="w-6 h-6">
                                        <path stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                                    </svg> : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff" className="w-6 h-6">
                ...
                <div className='hidden md:flex space-x-3 py-1 w-full items-center justify-center'>
                    <div className='hidden md:flex space-x-2 items-center justify-end w-full px-4'>
                        ...
                        <button onClick={() => data && updateFav(data)} className="flex"> {/* Use onClick with custom handler */}
                            <div className=" p-2 rounded-full hover:opacity-40 duration-150">
                                {!updatedFav ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" className="w-6 h-6">
                                    <path stroke="#ffffff" strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
                                </svg> : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#ffffff" className="w-6 h-6">
                                    <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z" clipRule="evenodd" />
